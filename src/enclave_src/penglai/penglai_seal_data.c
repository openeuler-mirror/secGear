...
{
    /* Penglai does not support this API now */
...
uint32_t penglai_seal_data(uint8_t *seal_data, uint32_t seal_data_len,
...
uint32_t penglai_unseal_data(void *sealed_data, uint8_t *decrypted_data,
