...
static shared_memory_block_t *create_shared_memory_block(void *host_buf,
    size_t host_buf_len, void *registered_buf)
{
    ...
    COND_INIT(&shared_mem->unregistered_cond, NULL);
...
static cc_enclave_result_t itrustee_register_shared_memory(void *host_buf, size_t host_buf_len,
    void* registered_buf, bool is_control_buf)
{
...
cc_enclave_result_t ecall_register_shared_memory(uint8_t *in_buf, size_t in_buf_size,
    uint8_t *out_buf, size_t out_buf_size, uint8_t *registered_buf, size_t *output_bytes_written)
{
    ...
    SET_PARAM_IN_1(is_control_buf_p, size_t, is_control_buf, args_size->is_control_buf_size);
...
cc_enclave_result_t ecall_unregister_shared_memory(uint8_t *in_buf, size_t in_buf_size,
