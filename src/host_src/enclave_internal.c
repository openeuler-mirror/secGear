...
static err2str g_secgearerror [] =
{
    ...
    {CC_ERROR_PCL_NOT_ENCRYPTED,          "PCL enclave is not encrypted."},
    ...
    {CC_ERROR_MSG_QUEUE_OVERFLOW,                "Service msg queue overflow."},
    ...
    {CC_ISOCKET_WARNING_PROTOCOL,                "Isocket warning protocol."},
