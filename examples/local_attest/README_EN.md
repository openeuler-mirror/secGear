...
make
// The paths of the local attestation QTA and remote attestation QTA are different. They will be unified in iTrustee_SDK.
...
// Modify the fields in secGear/examples/local_attest/enclave/manifest.txt based on the config.xml file corresponding to the target TA developer certificate.   
// Modify the encryptKey, signKey, and configPath paths in the secGear/examples/local_attest/enclaveconfig_cloud.ini file.   
// Uncomment the following lines in secGear/examples/local_attest/enclave/CMakeLists.txt to enable signature.
